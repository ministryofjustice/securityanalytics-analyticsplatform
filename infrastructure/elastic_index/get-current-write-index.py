...
if len(sys.argv[1:]) != 5:
    raise ValueError(f"get-current-write-index.py region app_name task_name index_name url")

region, app_name, task_name, index_name, url = sys.argv[1:]
...
alias = f"{task_name}:{index_name}:write"
